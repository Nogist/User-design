...
const ProjectContext = (props) => {
  return (
    <div className='projects__context'>
      <div className='projects__context__div'>
        <span>
          <img 
            src={props.picture}
            alt='Ui design'
      ...
      <div className='projects__context__div'>
        ...
        <span className='projects__context__buttons'>
          <button className='button__overlay' >{props.head2}</button>
          <button onClick={props.onHeadClicks}> {props.head2} </button>
        </span>
        <div>
          {props.topic &&  <span>
            {props.topic && <p>{props.topic}</p>}
          ...
          {props.linkaddress1 && <Link to={props.linkaddress1}>
            <button>view project</button>
          </Link>}
        </div>
      </div>
